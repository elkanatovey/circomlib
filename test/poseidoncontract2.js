...
const poseidonGenContract = require("../src/poseidon_gencontract2.js");
...
describe("Poseidon Smart contract test", function () {
    ...
    it("Should deploy the contract", async () => {
        ...
        C6 = new web3.eth.Contract(poseidonGenContract.generateABI(6));
    ...
    it("Should calculate the poseidon correctly for 6 inputs", async () => {

        const res = await poseidon6.methods.poseidon([1, 2, 3, 4, 0, 0]).call();

        // console.log("Cir: " + bigInt(res.toString(16)).toString(16));

        const res2 = poseidon([1, 2, 3, 4, 0, 0]);
        // console.log("Ref: " + bigInt(res2).toString(16));
